                                                    ...
                                                    <Row>
                                                        <Col xs={12} md={9}>
                                                            <hr />
                                                                ...
                                                                <div className={(descriptions.value[lang]?.neighbourhood?.length>400 || descriptions.value[lang]?.neighborhood?.length>400 || descriptions.value.en_US.neighbourhood?.length>400  || descriptions.value.en_US.neighborhood?.length>400) ? `prop-description-box ${showNeighborhoodReadMore ? 'show' : ''}`: undefined}>
                                                                    <h2 className="prop-section-title">{t("Neighborhood")}</h2>
                                                                    <h2>{t("Neighborhood")}</h2>
                                                                    <br />
                                                                    {descriptions.value[lang]?.neighbourhood?.substring(0,400)|| descriptions.value[lang]?.neighborhood?.substring(0,400) || descriptions.value.en_US.neighbourhood?.substring(0,400)  || descriptions.value.en_US.neighborhood?.substring(0,400) }
                                                                    {showNeighborhoodReadMore && <span id="more">
                                                                        {descriptions.value[lang]?.neighbourhood?.substring(400) || descriptions.value[lang]?.neighborhood?.substring(400) || descriptions.value.en_US.neighbourhood?.substring(400) || descriptions.value.en_US.neighborhood?.substring(400)}
                                                                        <br />
                                                                        <br />
