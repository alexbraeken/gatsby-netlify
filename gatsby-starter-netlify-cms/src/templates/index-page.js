...
import { GiSnowman } from "@react-icons/all-files/gi/GiSnowman";
import { FaSleigh } from "@react-icons/all-files/fa/FaSleigh";
import ChristmasLogo from '../img/christmas-logo.png'
        ...
        <div id="hero-overlay" ref={heroOverlay}></div>
          <div className="logo-container">
            <div className="hero-left">
              <img role="button" tabindex="0" className="hero-logo" id="hero-logo" ref={logo} onMouseEnter={handleLogoHover} onFocus={handleLogoHover} src={ChristmasLogo} alt="Smarta" />
            ...
            <div className="hero-right">
              ...
              <div id="logo-spinner">
                ...
                <div className="home-scroll-logo" id="home" ref={home} style={{maxWidth:"270px", textAlign:"center"}}><BsSnow2 /></div>
                <div className="home-scroll-logo" id="suitcase" ref={suitcase} style={{maxWidth:"270px", textAlign:"center"}}><GiSnowman /></div>
                <div className="home-scroll-logo" id="swim" ref={swim} style={{maxWidth:"270px", textAlign:"center"}}><FaSleigh /></div>
              </div>
            </div>
          </div>
          <SearchFilter className="search-filter" />
          <div style={{width: "100%", textAlign:"center", zIndex: "1", marginBottom: "-50px", marginTop:"50px", paddingBottom: "50px", backgroundColor:"#faf4e5"}}>
            <HeroBanner />
          </div>
      </div>
